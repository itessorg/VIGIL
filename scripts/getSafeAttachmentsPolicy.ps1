...
$safeAttachmentPolicies = Get-SafeAttachmentPolicy | Select-Object Identity | ConvertTo-Json -ErrorAction Stop  
  
Write-Output $safeAttachmentPolicies.Trim()  
